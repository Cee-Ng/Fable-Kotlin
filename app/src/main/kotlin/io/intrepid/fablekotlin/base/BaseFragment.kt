...
import io.intrepid.fablekotlin.FableKotlinApplication
import timber.log.Timber

abstract class BaseFragment<P : BaseContract.Presenter> : Fragment(), BaseContract.View {

    protected val fableKotlinApplication: FableKotlinApplication
        get() = activity.application as FableKotlinApplication
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val configuration = fableKotlinApplication.getPresenterConfiguration()
