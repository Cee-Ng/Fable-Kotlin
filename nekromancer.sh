...
if [ "$newPackageName" != "$oldPackageName" ]; then
    ...
    mv src/main/kotlin/io/intrepid/skotlinton/FableKotlinApplication.kt src/main/kotlin/io/intrepid/skotlinton/${newApplicationCapitalizedName}Application.kt
